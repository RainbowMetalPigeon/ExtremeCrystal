	object_const_def
	const ROUTE102_COOLTRAINER_M1
	const ROUTE102_COOLTRAINER_M2
	const ROUTE102_COOLTRAINER_F1
	const ROUTE102_COOLTRAINER_F2
	const ROUTE102_YOUNGSTER1
	const ROUTE102_YOUNGSTER2
	const ROUTE102_POKE_BALL1
	const ROUTE102_POKE_BALL2
	const ROUTE102_FISHER

Route102_MapScripts:
	def_scene_scripts
	scene_script Route102Noop1Scene, SCENE_ROUTE102_FIRST_STEP_INTO_KANTO
	scene_script Route102Noop2Scene, SCENE_ROUTE102_NOOP
...
FirstStepIntoKantoLeftScene:
	turnobject ROUTE102_FISHER, LEFT
	showemote EMOTE_SHOCK, ROUTE102_FISHER, 15
	applymovement ROUTE102_FISHER, Route102FisherStepLeftTwiceMovement
	sjump FirstStepIntoKantoScene_Continue

FirstStepIntoKantoRightScene:
	turnobject ROUTE102_FISHER, LEFT
	showemote EMOTE_SHOCK, ROUTE102_FISHER, 15
	applymovement ROUTE102_FISHER, Route102FisherStepLeftOnceMovement
FirstStepIntoKantoScene_Continue:
	turnobject PLAYER, RIGHT
	opentext
	writetext Route102FisherHeyText
	promptbutton
	writetext Route102FisherText
	waitbutton
	closetext
	setscene SCENE_ROUTE102_NOOP
	end
...
Route102FisherStepLeftTwiceMovement:
	step LEFT
	step LEFT
	step_end

Route102FisherStepLeftOnceMovement:
	step LEFT
	step_end

Route102FisherHeyText:
	text "Hey!"
	done
...
Route102_MapEvents:
	...
	def_warp_events
	warp_event 33,  7, ROUTE_102_SANDSTORM_HOUSE, 1
	warp_event 26,  5, TOHJO_FALLS, 1
	warp_event 36,  5, TOHJO_FALLS, 2

	def_coord_events
	coord_event 18, 10, SCENE_ROUTE102_FIRST_STEP_INTO_KANTO, FirstStepIntoKantoLeftScene
	coord_event 19, 10, SCENE_ROUTE102_FIRST_STEP_INTO_KANTO, FirstStepIntoKantoRightScene

	def_bg_events
	bg_event 25,  7, BGEVENT_READ, TohjoFallsSign

	def_object_events
	object_event 48,  7, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerCooltrainermBlake, -1 ; edited
	object_event 58,  6, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 4, TrainerCooltrainermBrian, -1 ; edited
	...
	object_event 60, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route102TMSolarbeam, EVENT_ROUTE_102_TM_SOLARBEAM
	object_event 53, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route102RareCandy, EVENT_ROUTE_102_RARE_CANDY
	object_event 21, 10, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 3, Route102FisherScript, -1
