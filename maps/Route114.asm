	object_const_def
	const ROUTE114_SAILOR
	const ROUTE114_POKEFAN_M
	const ROUTE114_POKEFAN_F1
	const ROUTE114_MILTANK1
	const ROUTE114_MILTANK2
	const ROUTE114_MILTANK3
	const ROUTE114_MILTANK4
	const ROUTE114_PSYCHIC_NORMAN
	const ROUTE114_FRUIT_TREE
	const ROUTE114_POKEFAN_F2
...
Route114TrainerTips:
	jumptext Route114TrainerTipsText

Route114FruitTree:
	fruittree FRUITTREE_ROUTE_39

Route114HiddenNugget:
...
Route114_MapEvents:
	...
	def_bg_events
	bg_event  5, 31, BGEVENT_READ, Route114TrainerTips
	bg_event  9,  5, BGEVENT_READ, MoomooFarmSign
	bg_event 15,  7, BGEVENT_READ, Route114Sign
	bg_event  5, 13, BGEVENT_ITEM, Route114HiddenNugget
	...
	object_event  3, 12, SPRITE_TAUROS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route114Miltank, -1
	object_event  6, 11, SPRITE_TAUROS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route114Miltank, -1
	object_event  4, 15, SPRITE_TAUROS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route114Miltank, -1
	object_event  8, 13, SPRITE_TAUROS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route114Miltank, -1
	...
	object_event  9,  3, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route114FruitTree, -1
