	object_const_def
	const ROUTE110_YOUNGSTER1
	const ROUTE110_YOUNGSTER2
	const ROUTE110_LASS1
	const ROUTE110_LASS2
	const ROUTE110_YOUNGSTER3
	const ROUTE110_FISHER
	const ROUTE110_BUG_CATCHER
	const ROUTE110_SUPER_NERD
	const ROUTE110_OFFICER
	const ROUTE110_FRUIT_TREE
	const ROUTE110_POKE_BALL
...
.Script:
	...
	iftrue Route110NumberAcceptedM
	checkevent EVENT_IRWIN_ASKED_FOR_PHONE_NUMBER
	iftrue .AskedAlready
	writetext JugglerIrwinAfterBattleText
	promptbutton
	setevent EVENT_IRWIN_ASKED_FOR_PHONE_NUMBER
	scall Route110AskNumber1M
	sjump .AskForNumber

.AskedAlready:
	scall Route110AskNumber2M
.AskForNumber:
	askforphonenumber PHONE_JUGGLER_IRWIN
	ifequal PHONE_CONTACTS_FULL, Route110PhoneFullM
	ifequal PHONE_CONTACT_REFUSED, Route110NumberDeclinedM
	gettrainername STRING_BUFFER_3, JUGGLER, IRWIN1
	scall Route110RegisteredNumberM
	sjump Route110NumberAcceptedM
...
Route110RegisteredNumberM:
	jumpstd RegisteredNumberMScript
	end

Route110NumberAcceptedM:
	jumpstd NumberAcceptedMScript
	end

Route110NumberDeclinedM:
...
Route110_MapEvents:
	...
	def_warp_events
	warp_event  9, 51, ROUTE_110_GOLDENROD_GATE, 1
	warp_event 10, 51, ROUTE_110_GOLDENROD_GATE, 2
	warp_event  3, 23, ROUTE_110_NATIONAL_PARK_GATE, 3
	...
	def_bg_events
	bg_event  1, 25, BGEVENT_READ, Route110Sign
	bg_event 11, 49, BGEVENT_READ, Route110Sign

	def_object_events
	object_event  4, 37, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 2, TrainerCamperIvan, -1
	object_event  8, 38, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 3, TrainerCamperElliot, -1
	object_event  7, 38, SPRITE_LASS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 3, TrainerPicnickerBrooke, -1
	object_event 10, 44, SPRITE_LASS, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 1, TrainerPicnickerKim, -1
	object_event 14, 46, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 0, TrainerBirdKeeperBryan, -1
	object_event  2, 28, SPRITE_FISHER, SPRITEMOVEDATA_SPINCOUNTERCLOCKWISE, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 2, TrainerFirebreatherWalt, -1
	object_event 16, 25, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_DOWN, 2, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 3, TrainerBugCatcherArnie, -1
	object_event  5, 28, SPRITE_SUPER_NERD, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerJugglerIrwin, -1
	object_event  5, 24, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, TrainerOfficerDirk, -1
	object_event  2, 43, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route110FruitTree, -1
	object_event 13, 34, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route110TMRollout, EVENT_ROUTE_110_TM_ROLLOUT
