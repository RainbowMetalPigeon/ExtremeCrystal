...
Route110_MapEvents:
	...
	def_warp_events
	warp_event  9, 33, ROUTE_110_GOLDENROD_GATE, 1
	warp_event 10, 33, ROUTE_110_GOLDENROD_GATE, 2
	warp_event  3,  5, ROUTE_110_NATIONAL_PARK_GATE, 3

	def_coord_events

	def_bg_events
	bg_event  1,  7, BGEVENT_READ, Route110Sign
	bg_event 11, 31, BGEVENT_READ, Route110Sign
	...
	object_event  2, 25, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route110FruitTree, -1
	object_event 13, 16, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route110TMRollout, EVENT_ROUTE_110_TM_ROLLOUT
