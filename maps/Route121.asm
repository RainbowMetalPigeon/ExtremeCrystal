	object_const_def
	const ROUTE121_POKEFAN_M
	const ROUTE121_YOUNGSTER
	const ROUTE121_LASS
	const ROUTE121_FRUIT_TREE1
	const ROUTE121_FRUIT_TREE2
	const ROUTE121_POKE_BALL
...
.Script:
	...
	iftrue Route121NumberAcceptedF
	checkevent EVENT_ERIN_ASKED_FOR_PHONE_NUMBER
	iftrue .AskedAlready
	writetext PicnickerErinAfterBattleText
	promptbutton
	setevent EVENT_ERIN_ASKED_FOR_PHONE_NUMBER
	scall Route121AskNumber1F
	sjump .AskForNumber

.AskedAlready:
	scall Route121AskNumber2F
.AskForNumber:
	askforphonenumber PHONE_PICNICKER_ERIN
	ifequal PHONE_CONTACTS_FULL, Route121PhoneFullF
	ifequal PHONE_CONTACT_REFUSED, Route121NumberDeclinedF
	gettrainername STRING_BUFFER_3, PICNICKER, ERIN1
	scall Route121RegisteredNumberF
	sjump Route121NumberAcceptedF

.WantsBattle:
	scall Route121RematchF
...
Route121RegisteredNumberF:
	jumpstd RegisteredNumberFScript
	end

Route121NumberAcceptedF:
	jumpstd NumberAcceptedFScript
	end

Route121NumberDeclinedF:
...
Route121_MapEvents:
	...
	def_warp_events
	warp_event  7, 33, ROUTE_104_ROUTE_121_GATE, 1
	warp_event  8, 33, ROUTE_104_ROUTE_121_GATE, 2
	warp_event 14,  5, DARK_CAVE_VIOLET_ENTRANCE, 3

	def_coord_events

	def_bg_events
	bg_event  9, 27, BGEVENT_READ, Route121Sign
	...
	object_event  7,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route121FruitTree1, -1
	object_event  8,  6, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route121FruitTree2, -1
	object_event  1, 15, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route121XSpeed, EVENT_ROUTE_121_X_SPEED
