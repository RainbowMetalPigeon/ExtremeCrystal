	object_const_def
	const ROUTE102SANDSTORMHOUSE_GRANNY

Route102SandstormHouse_MapScripts:
	def_scene_scripts
...
Route102SandstormHouse_MapEvents:
	db 0, 0 ; filler

	def_warp_events
	warp_event  2,  7, ROUTE_102, 1
	warp_event  3,  7, ROUTE_102, 1
