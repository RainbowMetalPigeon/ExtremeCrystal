	object_const_def
	const ROUTE113_STANDING_YOUNGSTER1
	const ROUTE113_LASS
	const ROUTE113_STANDING_YOUNGSTER2
	const ROUTE113_BEAUTY1
	const ROUTE113_SAILOR
	const ROUTE113_FRUIT_TREE
	const ROUTE113_BEAUTY2
...
Route113_MapEvents:
	...
	def_warp_events
	warp_event 35,  8, ROUTE_113_ECRUTEAK_GATE, 1
	warp_event 35,  9, ROUTE_113_ECRUTEAK_GATE, 2

	def_coord_events

	def_bg_events
	bg_event 33,  7, BGEVENT_READ, Route113Sign
	bg_event  5, 13, BGEVENT_READ, Route113TrainerTips
	...
	object_event 12, 10, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route113FruitTree, -1
