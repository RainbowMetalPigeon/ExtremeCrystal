	object_const_def
	const ROUTE103STEELWINGHOUSE_CELEBRITY
	const ROUTE103STEELWINGHOUSE_FEAROW

Route103SteelWingHouse_MapScripts:
	def_scene_scripts
	scene_script Route103SteelWingHouseNoopScene ; unusable

	def_callbacks

Route103SteelWingHouseNoopScene:
	end
...
Route103SteelWingHouse_MapEvents:
	db 0, 0 ; filler

	def_warp_events
	warp_event  2,  7, ROUTE_103, 1
	warp_event  3,  7, ROUTE_103, 1
