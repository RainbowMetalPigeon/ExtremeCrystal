	object_const_def
	const ROUTE107_FISHER1
	const ROUTE107_FISHER2
	const ROUTE107_FISHER3
	const ROUTE107_YOUNGSTER1
	const ROUTE107_YOUNGSTER2
	const ROUTE107_YOUNGSTER3
	const ROUTE107_LASS1
	const ROUTE107_COOLTRAINER_M
	const ROUTE107_YOUNGSTER4
	const ROUTE107_FISHER4
	const ROUTE107_POKE_BALL1
	const ROUTE107_FISHER5
	const ROUTE107_FRIEDA
	const ROUTE107_POKE_BALL2
...
Route107FriedaCallback:
	readvar VAR_WEEKDAY
	ifequal FRIDAY, .FriedaAppears
	disappear ROUTE107_FRIEDA
	endcallback
...
.GiveMiracleSeed:
	writetext Route107CooltrainerMText_HaveThisSeed
	promptbutton
...
Route107WannaBuyASlowpokeTailScript:
	turnobject ROUTE107_FISHER4, DOWN
...
Route107Sign:
	jumptext Route107SignText

Route107RuinsSign:
	jumptext Route107RuinsSignText
...
Route107HiddenGreatBall:
	hiddenitem GREAT_BALL, EVENT_ROUTE_107_HIDDEN_GREAT_BALL

Route107HiddenSuperPotion:
	hiddenitem SUPER_POTION, EVENT_ROUTE_107_HIDDEN_SUPER_POTION

Movement_Route107CooltrainerMPushesYouBackToViolet:
	step UP
	step UP
	step_end

Movement_Route107CooltrainerMReset1:
	step DOWN
	step_end

Movement_Route107CooltrainerMReset2:
	step RIGHT
	step_end
...
Route107CooltrainerMText_ExperiencesShouldBeUseful:
...
Route107UnusedFisher1SeenText: ; unreferenced
...
Route107UnusedFisher1BeatenText: ; unreferenced
	text "Nothing ever goes"
	line "right for me now…"
	done

Route107UnusedFisher1AfterText: ; unreferenced
	text "How come the guy"
	line "next to me catches"
	cont "good #MON?"
	done

Route107UnusedFisher2SeenText: ; unreferenced
	text "Heh, I'm on a roll"
	line "today. How about a"
	cont "battle, kid?"
	done

Route107UnusedFisher2BeatenText: ; unreferenced
	text "Oof. I wasn't"
	line "lucky that time."
	done

Route107UnusedFisher2AfterText: ; unreferenced
...
Route107UnusedText: ; unreferenced
	text "The fishermen"
...
Route107RuinsSignText:
	text "RUINS OF ALPH"
	line "EAST ENTRANCE"
	done

Route107UnionCaveSignText:
	text "UNION CAVE"
	line "AHEAD"
	done
...
Route107_MapEvents:
	...
	def_warp_events
	warp_event 11, 73, ROUTE_107_POKECENTER_1F, 1
...
;	coord_event 18,  8, SCENE_ROUTE107_COOLTRAINER_M_BLOCKS, Route107CooltrainerMStopsYouScene ; edited away
	...
	def_bg_events
	bg_event 13,  5, BGEVENT_READ, Route107Sign
	bg_event  9,  1, BGEVENT_READ, Route107RuinsSign
	bg_event 10, 84, BGEVENT_READ, Route107UnionCaveSign
	...
	object_event 19,  8, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route107CooltrainerMScript, -1
	...
	object_event  6, 53, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route107GreatBall, EVENT_ROUTE_107_GREAT_BALL
	object_event 15, 13, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route107RoarTMGuyScript, -1
	object_event 12, 67, SPRITE_LASS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, FriedaScript, EVENT_ROUTE_107_FRIEDA_OF_FRIDAY
	object_event  3, 30, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route107Repel, EVENT_ROUTE_107_REPEL
