	object_const_def
	const ROUTE122_ROCK1
	const ROUTE122_ROCK2
	const ROUTE122_ROCK3
	const ROUTE122_ROCK4
	const ROUTE122_ROCK5
	const ROUTE122_ROCK6
	const ROUTE122_ROCK7
	const ROUTE122_BOULDER1
	const ROUTE122_BOULDER2
	const ROUTE122_BOULDER3
	const ROUTE122_BOULDER4
	const ROUTE122_BOULDER5
	const ROUTE122_POKE_BALL1
	const ROUTE122_POKE_BALL2
	const ROUTE122_POKE_BALL3
	const ROUTE122_POKE_BALL4
;	const ROUTE122_POKEFAN_M
