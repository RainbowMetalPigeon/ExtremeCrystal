DEF ROUTE114FARMHOUSE_MILK_PRICE EQU 500

	object_const_def
	const ROUTE114FARMHOUSE_POKEFAN_M
	const ROUTE114FARMHOUSE_POKEFAN_F

Route114Farmhouse_MapScripts:
	def_scene_scripts
...
FarmerMScript_SellMilk:
	...
	checkmoney YOUR_MONEY, ROUTE114FARMHOUSE_MILK_PRICE
	ifequal HAVE_LESS, FarmerMScript_NoMoney
	giveitem MOOMOO_MILK
	iffalse FarmerMScript_NoRoom
	takemoney YOUR_MONEY, ROUTE114FARMHOUSE_MILK_PRICE
	special PlaceMoneyTopRight
	waitsfx
...
FarmerMText_BuyMilk:
	...
	line "fer just ¥{d:ROUTE114FARMHOUSE_MILK_PRICE}."
	done
