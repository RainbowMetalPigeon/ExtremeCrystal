	object_const_def
	const ROUTE109_YOUNGSTER1
	const ROUTE109_YOUNGSTER2
	const ROUTE109_YOUNGSTER3
	const ROUTE109_LASS
	const ROUTE109_OFFICER
	const ROUTE109_POKEFAN_M
	const ROUTE109_GRAMPS
	const ROUTE109_DAY_CARE_MON_1
	const ROUTE109_DAY_CARE_MON_2
	const ROUTE109_COOLTRAINER_F1
	const ROUTE109_COOLTRAINER_F2
	const ROUTE109_COOLTRAINER_F3
	const ROUTE109_POKE_BALL

Route109_MapScripts:
	def_scene_scripts

	def_callbacks
	callback MAPCALLBACK_OBJECTS, Route109EggCheckCallback

Route109EggCheckCallback:
...
DayCareManScript_Outside:
	...
	applymovement ROUTE109_GRAMPS, Route109MovementData_DayCareManWalksBackInside
	playsound SFX_ENTER_DOOR
	disappear ROUTE109_GRAMPS
.end_fail
	end

.walk_around_player
	applymovement ROUTE109_GRAMPS, Route109MovementData_DayCareManWalksBackInside_WalkAroundPlayer
	playsound SFX_ENTER_DOOR
	disappear ROUTE109_GRAMPS
	end
...
Route109IlexForestSign: ; unreferenced
	jumptext Route109IlexForestSignText
...
Route109HiddenRareCandy:
	hiddenitem RARE_CANDY, EVENT_ROUTE_109_HIDDEN_RARE_CANDY

Route109HiddenSuperPotion:
	hiddenitem SUPER_POTION, EVENT_ROUTE_109_HIDDEN_SUPER_POTION

Route109MovementData_DayCareManWalksBackInside:
	slow_step LEFT
	slow_step LEFT
	slow_step UP
	step_end

Route109MovementData_DayCareManWalksBackInside_WalkAroundPlayer:
	slow_step DOWN
	slow_step LEFT
	slow_step LEFT
	slow_step UP
...
Route109_MapEvents:
	...
	def_warp_events
	warp_event 13, 37, ROUTE_109_ILEX_FOREST_GATE, 1
	warp_event 14, 37, ROUTE_109_ILEX_FOREST_GATE, 2
	...
	def_bg_events
	bg_event 12,  6, BGEVENT_READ, Route109Sign
	bg_event 13, 33, BGEVENT_READ, Route109TrainerTips
	bg_event 10, 13, BGEVENT_READ, DayCareSign
	bg_event  8, 32, BGEVENT_ITEM, Route109HiddenRareCandy
	bg_event 17, 19, BGEVENT_ITEM, Route109HiddenSuperPotion
	...
	object_event 15, 16, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, DayCareManScript_Outside, EVENT_DAY_CARE_MAN_ON_ROUTE_109
	...
	object_event  7, 30, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route109Nugget, EVENT_ROUTE_109_NUGGET
