...
AzaleaTownCelebiScene:
	...
	setevent EVENT_ROUTE_109_ILEX_FOREST_GATE_LASS
	setscene SCENE_AZALEATOWN_NOOP
	closetext
	end
...
AzaleaTown_MapEvents:
	...
	def_bg_events ; edited
	bg_event 22,  9, BGEVENT_READ, AzaleaTownSign
	...
	bg_event 14,  9, BGEVENT_READ, AzaleaTownPokecenterSign
	bg_event 18,  9, BGEVENT_READ, AzaleaTownMartSign
	...
	object_event 21,  6, SPRITE_GRAMPS, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownGrampsScript, -1
	...
	object_event 21,  9, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownSlowpokeScript, EVENT_AZALEA_TOWN_SLOWPOKES
