	object_const_def
	const ROUTE112_WEIRD_TREE1
	const ROUTE112_WEIRD_TREE2
	const ROUTE112_YOUNGSTER
	const ROUTE112_FRUIT_TREE1
	const ROUTE112_SUNNY
	const ROUTE112_FRUIT_TREE2
	const ROUTE112_FRUIT_TREE3

Route112_MapScripts:
	def_scene_scripts

	def_callbacks
	callback MAPCALLBACK_OBJECTS, Route112SunnyCallback

Route112SunnyCallback:
	readvar VAR_WEEKDAY
	ifequal SUNDAY, .SunnyAppears
	disappear ROUTE112_SUNNY
	endcallback

.SunnyAppears:
	appear ROUTE112_SUNNY
	endcallback
...
Route112FruitTree3:
	fruittree FRUITTREE_ROUTE_112_3

Route112HiddenEther:
	hiddenitem ETHER, EVENT_ROUTE_112_HIDDEN_ETHER
...
Route112_MapEvents:
	...
	def_bg_events
	bg_event  5,  3, BGEVENT_READ, Route112Sign
	bg_event  4,  2, BGEVENT_ITEM, Route112HiddenEther
	...
	object_event 13,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route112FruitTree1, -1
	object_event 16,  8, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SunnyScript, EVENT_ROUTE_112_SUNNY_OF_SUNDAY
	object_event 16,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route112FruitTree2, -1
	object_event 15,  7, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route112FruitTree3, -1
