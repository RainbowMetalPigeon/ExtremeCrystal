	...
	const ROUTE119_YOUNGSTER1
	const ROUTE119_SUPER_NERD
	const ROUTE119_YOUNGSTER2
	const ROUTE119_COOLTRAINER_M
	const ROUTE119_COOLTRAINER_F
	const ROUTE119_FRUIT_TREE
	const ROUTE119_POKE_BALL1
	const ROUTE119_POKE_BALL2
	const ROUTE119_POKE_BALL3
...
.Script:
	...
	iftrue Route119NumberAcceptedM
	checkevent EVENT_VANCE_ASKED_FOR_PHONE_NUMBER
	iftrue .AskedAlready
	writetext BirdKeeperVanceLegendaryBirdsText
	promptbutton
	setevent EVENT_VANCE_ASKED_FOR_PHONE_NUMBER
	scall Route119AskNumber1M
	sjump .AskForNumber

.AskedAlready:
	scall Route119AskNumber2M
.AskForNumber:
	askforphonenumber PHONE_BIRDKEEPER_VANCE
	ifequal PHONE_CONTACTS_FULL, Route119PhoneFullM
	ifequal PHONE_CONTACT_REFUSED, Route119NumberDeclinedM
	gettrainername STRING_BUFFER_3, BIRD_KEEPER, VANCE1
	scall Route119RegisteredNumberM
	sjump Route119NumberAcceptedM

.WantsBattle:
	scall Route119RematchM
...
Route119RegisteredNumberM:
	jumpstd RegisteredNumberMScript
	end

Route119NumberAcceptedM:
	jumpstd NumberAcceptedMScript
	end

Route119NumberDeclinedM:
...
Route119Sign1:
	jumptext Route119Sign1Text

Route119Sign2:
	jumptext Route119Sign2Text
...
Route119HiddenElixer:
	hiddenitem ELIXER, EVENT_ROUTE_119_HIDDEN_ELIXER
...
Route119_MapEvents:
	...
	def_bg_events
	bg_event 53,  7, BGEVENT_READ, Route119Sign1
	bg_event  6, 10, BGEVENT_READ, Route119Sign2
	bg_event 32,  9, BGEVENT_ITEM, Route119HiddenElixer
	...
	object_event  9,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route119FruitTree, -1
	object_event 30,  8, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route119MaxRevive, EVENT_ROUTE_119_MAX_REVIVE
	object_event 45,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route119UltraBall, EVENT_ROUTE_119_ULTRA_BALL
	object_event 14,  9, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route119MaxRepel, EVENT_ROUTE_119_MAX_REPEL
