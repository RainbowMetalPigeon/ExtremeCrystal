	object_const_def
	const ROUTE118_SUPER_NERD1
	const ROUTE118_SUPER_NERD2
	const ROUTE118_SUPER_NERD3
	const ROUTE118_FISHER
	const ROUTE118_LASS
...
Route118_MapScripts:
	...
	def_callbacks
	callback MAPCALLBACK_NEWMAP, Route118CheckIfRocketsScene

Route118CheckIfRocketsScene:
	checkevent EVENT_CLEARED_ROCKET_HIDEOUT
	iftrue .NoRockets
	setmapscene ROUTE_118_GATE, SCENE_ROUTE118GATE_ROCKET_SHAKEDOWN
	endcallback

.NoRockets:
	setmapscene ROUTE_118_GATE, SCENE_ROUTE118GATE_NOOP
	endcallback
...
Route118Sign1:
	jumptext Route118Sign1Text

Route118Sign2:
	jumptext Route118Sign2Text

Route118TrainerTips:
	jumptext Route118TrainerTipsText
...
Route118_MapEvents:
	...
	def_warp_events
	warp_event  9, 51, ROUTE_118_MAHOGANY_GATE, 1
	warp_event 10, 51, ROUTE_118_MAHOGANY_GATE, 2
	warp_event 17, 35, ROUTE_118_GATE, 3
	warp_event 17, 31, ROUTE_118_GATE, 1
	warp_event 18, 31, ROUTE_118_GATE, 2

	def_coord_events

	def_bg_events
	bg_event 13,  3, BGEVENT_READ, Route118Sign1
	bg_event 11, 49, BGEVENT_READ, Route118Sign2
	bg_event 16, 38, BGEVENT_READ, Route118TrainerTips
	...
	object_event  1, 26, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route118FruitTree, -1
	object_event 12, 32, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route118MaxEther, EVENT_ROUTE_118_MAX_ETHER
