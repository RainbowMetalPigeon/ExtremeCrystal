	object_const_def
	const ROUTE120_POKEFAN_M1
	const ROUTE120_POKEFAN_M2
	const ROUTE120_POKEFAN_M3
	const ROUTE120_POKEFAN_M4
	const ROUTE120_BLACK_BELT
	const ROUTE120_COOLTRAINER_M
	const ROUTE120_COOLTRAINER_F
	const ROUTE120_FRUIT_TREE
	const ROUTE120_POKE_BALL1
...
.Script:
	...
	scall Route120AskNumber1M
	sjump .AskForNumber

.AskedAlready:
	scall Route120AskNumber2M
.AskForNumber:
	askforphonenumber PHONE_BLACKBELT_KENJI
	ifequal PHONE_CONTACTS_FULL, Route120PhoneFullM
	ifequal PHONE_CONTACT_REFUSED, Route120NumberDeclinedM
	gettrainername STRING_BUFFER_3, BLACKBELT_T, KENJI3
	scall Route120RegisteredNumberM
	sjump Route120NumberAcceptedM

.Registered:
	readvar VAR_KENJI_BREAK
	ifnotequal 1, Route120NumberAcceptedM
	checktime MORN
	iftrue .Morning
	checktime NITE
	iftrue .Night
	checkevent EVENT_KENJI_ON_BREAK
	iffalse Route120NumberAcceptedM
	scall Route120GiftM
...
Route120RegisteredNumberM:
	jumpstd RegisteredNumberMScript
	end

Route120NumberAcceptedM:
	jumpstd NumberAcceptedMScript
	end

Route120NumberDeclinedM:
...
.Script:
	...
	iftrue Route120NumberAcceptedM
...
Route120DummyScript: ; unreferenced
	writetext Route120DummyText
	waitbutton
	closetext
	end

Route120Sign:
	jumptext Route120SignText
...
Route120HiddenPpUp:
	hiddenitem PP_UP, EVENT_ROUTE_120_HIDDEN_PP_UP
...
Route120_MapEvents:
	...
	def_bg_events
	bg_event 10,  4, BGEVENT_READ, Route120Sign
	bg_event 13, 80, BGEVENT_ITEM, Route120HiddenPpUp
	...
	object_event 16, 82, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route120FruitTree, -1
	object_event  6, 51, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route120Nugget, EVENT_ROUTE_120_NUGGET
	object_event  5, 66, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route120Revive, EVENT_ROUTE_120_REVIVE
	object_event  6, 20, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route120Elixer, EVENT_ROUTE_120_ELIXER
	object_event  7, 33, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route120MaxPotion, EVENT_ROUTE_120_MAX_POTION
