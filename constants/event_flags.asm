...
; Johto story events
	const EVENT_GOT_A_POKEMON_FROM_ELM ; TBE
	const EVENT_GOT_CYNDAQUIL_FROM_ELM ; TBE
	const EVENT_GOT_TOTODILE_FROM_ELM ; TBE
	const EVENT_GOT_CHIKORITA_FROM_ELM ; TBE
	...
	const EVENT_GOT_BERRY_FROM_ROUTE_105_HOUSE
	...
	const EVENT_GOT_WYNAUT_EGG_FROM_MX_POKEMON
	...
	const EVENT_WYNAUT_HATCHED
	const EVENT_SHOWED_WYNAUT_TO_ELM ; edited
	...
	const EVENT_GOT_MIRACLE_SEED_IN_ROUTE_107
	...
	const EVENT_TOLD_ELM_ABOUT_WYNAUT_OVER_THE_PHONE
...
; Johto hidden items
	...
	const EVENT_ROUTE_103_HIDDEN_RARE_CANDY
	const EVENT_ROUTE_105_HIDDEN_POTION
	const EVENT_ROUTE_107_HIDDEN_GREAT_BALL
	const EVENT_ROUTE_107_HIDDEN_SUPER_POTION
	const EVENT_ROUTE_109_HIDDEN_RARE_CANDY
	const EVENT_ROUTE_109_HIDDEN_SUPER_POTION
	const EVENT_ROUTE_112_HIDDEN_ETHER
	const EVENT_ROUTE_39_HIDDEN_NUGGET
	const EVENT_ROUTE_115_HIDDEN_HYPER_POTION
	const EVENT_ROUTE_116_HIDDEN_MAX_ETHER
	const EVENT_ROUTE_117_HIDDEN_MAX_POTION
	const EVENT_ROUTE_119_HIDDEN_ELIXER
	const EVENT_ROUTE_120_HIDDEN_PP_UP
...
; More Johto story events
	const EVENT_WARPED_FROM_ROUTE_110_NATIONAL_PARK_GATE
...
; Johto itemballs
	...
	const EVENT_ROUTE_101_MAX_ELIXER
	const EVENT_ROUTE_102_TM_SOLARBEAM
	const EVENT_ROUTE_102_RARE_CANDY
	const EVENT_ROUTE_104_POTION
	const EVENT_ROUTE_106_POTION
	const EVENT_ROUTE_106_POKE_BALL
	const EVENT_ROUTE_107_GREAT_BALL
	const EVENT_ROUTE_107_REPEL
	const EVENT_ROUTE_110_TM_ROLLOUT
	const EVENT_ROUTE_117_ULTRA_BALL
	const EVENT_ROUTE_117_SUPER_POTION
	const EVENT_ROUTE_118_MAX_ETHER
	const EVENT_ROUTE_119_MAX_REVIVE
	const EVENT_ROUTE_119_ULTRA_BALL
	const EVENT_ROUTE_120_NUGGET
	const EVENT_ROUTE_120_REVIVE
	const EVENT_ROUTE_120_ELIXER
	const EVENT_ROUTE_120_MAX_POTION
	const EVENT_ROUTE_121_X_SPEED
; Johto people
	...
	const EVENT_ROUTE_118_GATE_ROCKETS
	...
	const EVENT_DAY_CARE_MAN_ON_ROUTE_109
	const EVENT_DAY_CARE_MON_1
	const EVENT_DAY_CARE_MON_2
	const EVENT_ILEX_FOREST_FARFETCHD
	const EVENT_ROUTE_109_ILEX_FOREST_GATE_TEACHER_BEHIND_COUNTER
	const EVENT_ROUTE_109_ILEX_FOREST_GATE_LASS
	const EVENT_ROUTE_109_ILEX_FOREST_GATE_TEACHER_IN_WALKWAY
	...
	const EVENT_ROUTE_111_SUDOWOODO
...
;	const EVENT_ROUTE_105_BATTLE
	const EVENT_ROUTE_105_YOUNGSTER_JOEY ; TBE
	...
	const EVENT_ROUTE_110_NATIONAL_PARK_GATE_YOUNGSTER
	...
	const EVENT_ROUTE_110_NATIONAL_PARK_GATE_OFFICER_CONTEST_DAY
	const EVENT_ROUTE_110_NATIONAL_PARK_GATE_OFFICER_NOT_CONTEST_DAY
	const EVENT_ROUTE_111_NATIONAL_PARK_GATE_OFFICER_CONTEST_DAY
	const EVENT_ROUTE_111_NATIONAL_PARK_GATE_OFFICER_NOT_CONTEST_DAY
	...
	const EVENT_ROUTE_107_FRIEDA_OF_FRIDAY
	const EVENT_ROUTE_104_TUSCANY_OF_TUESDAY
	const EVENT_ROUTE_111_ARTHUR_OF_THURSDAY
	const EVENT_ROUTE_112_SUNNY_OF_SUNDAY
	const EVENT_LAKE_OF_RAGE_WESLEY_OF_WEDNESDAY
	const EVENT_BLACKTHORN_CITY_SANTOS_OF_SATURDAY
	const EVENT_ROUTE_115_MONICA_OF_MONDAY
...
; New to Crystal
	...
	const EVENT_SAW_SUICUNE_ON_ROUTE_117
	const EVENT_SAW_SUICUNE_ON_ROUTE_111
	...
	const EVENT_ROUTE_109_NUGGET
	const EVENT_ROUTE_119_MAX_REPEL
...
; New to Extreme Crystal
	...
	const EVENT_PLAYERS_NEIGHBORS_HOUSE_OPAL
	const EVENT_ROUTE_122_HIDDEN_RARE_CANDY_1
	const EVENT_ROUTE_122_HIDDEN_RARE_CANDY_2
	const EVENT_ROUTE_122_HIDDEN_ETHER
	const EVENT_ROUTE_122_HIDDEN_ULTRA_BALL
	const EVENT_ROUTE_122_HIDDEN_MAX_ELIXER
	const EVENT_ROUTE_122_HIDDEN_PP_UP
	const EVENT_ROUTE_122_MAX_REVIVE
	const EVENT_ROUTE_122_PP_UP
	const EVENT_ROUTE_122_GREAT_BALL
	const EVENT_ROUTE_122_MAX_ETHER
	const EVENT_ROUTE_104_RIVAL
	const EVENT_ROUTE_104_OPAL_1
	const EVENT_ROUTE_104_OPAL_2
	const EVENT_OPAL_IN_ELMS_LAB
	const EVENT_COP_AND_OPAL_LEFT_ELMS_LAB
	const EVENT_GOT_TOGEPI_FROM_OPAL
