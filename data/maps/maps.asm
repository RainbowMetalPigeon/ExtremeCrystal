...
MapGroup_Olivine:
	...
	map Route113EcruteakGate, TILESET_GATE, GATE, LANDMARK_ROUTE_113, MUSIC_ROUTE_112, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route114Barn, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ROUTE_39, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route114Farmhouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_39, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route113, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_113, MUSIC_ROUTE_112, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route114, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_39, MUSIC_ROUTE_112, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Mahogany:
	...
	map Route117EcruteakGate, TILESET_GATE, GATE, LANDMARK_ROUTE_117, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route117, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_117, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route119, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_119, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Dungeons:
	...
	map RadioTower1F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_RADIO_TOWER, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE ; edited, to fix Music ID bug
	map RadioTower2F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_RADIO_TOWER, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE ; edited, to fix Music ID bug
	map RadioTower3F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_RADIO_TOWER, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE ; edited, to fix Music ID bug
	map RadioTower4F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_RADIO_TOWER, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE ; edited, to fix Music ID bug
	map RadioTower5F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_RADIO_TOWER, MUSIC_RADIO_TOWER, TRUE, PALETTE_DAY, FISHGROUP_SHORE ; edited, to fix Music ID bug
...
MapGroup_Blackthorn:
	...
	map Route120, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_120, MUSIC_ROUTE_111, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
	map Route121, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_121, MUSIC_ROUTE_111, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Azalea:
	...
	map Route108, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_108, MUSIC_ROUTE_105, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_LakeOfRage:
	...
	map Route118MahoganyGate, TILESET_GATE, GATE, LANDMARK_ROUTE_118, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route118Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_118, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route118, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_118, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Violet:
	...
	map Route107, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_107, MUSIC_ROUTE_105, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	map Route110, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_110, MUSIC_ROUTE_111, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route111, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_111, MUSIC_ROUTE_111, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route112, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_112, MUSIC_ROUTE_111, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map Route107RuinsOfAlphGate, TILESET_GATE, GATE, LANDMARK_ROUTE_107, MUSIC_ROUTE_105, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route107Pokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_107, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route110GoldenrodGate, TILESET_GATE, GATE, LANDMARK_ROUTE_110, MUSIC_ROUTE_111, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route110NationalParkGate, TILESET_GATE, INDOOR, LANDMARK_ROUTE_110, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route111RuinsOfAlphGate, TILESET_GATE, GATE, LANDMARK_ROUTE_111, MUSIC_ROUTE_111, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route111NationalParkGate, TILESET_GATE, INDOOR, LANDMARK_ROUTE_111, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_VIOLET_MAPS

MapGroup_Goldenrod:
	table_width MAP_LENGTH, MapGroup_Goldenrod
	map Route109, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_109, MUSIC_ROUTE_111, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map IlexForestAzaleaGate, TILESET_GATE, GATE, LANDMARK_ROUTE_109, MUSIC_ROUTE_111, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route109IlexForestGate, TILESET_GATE, GATE, LANDMARK_ROUTE_109, MUSIC_ROUTE_111, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map DayCare, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_109, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Silver:
	...
	map Route103, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_103, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map Route103SteelWingHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_103, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map Route115, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_115, MUSIC_ROUTE_111, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route116, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_116, MUSIC_ROUTE_111, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map Route115BattleTowerGate, TILESET_GATE, GATE, LANDMARK_BATTLE_TOWER, MUSIC_ROUTE_111, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map VictoryRoadGate, TILESET_GATE, GATE, LANDMARK_ROUTE_101, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_VIRIDIAN_MAPS

MapGroup_NewBark:
	table_width MAP_LENGTH, MapGroup_NewBark
	map Route101, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_101, MUSIC_ROUTE_101, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route102, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_102, MUSIC_ROUTE_101, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route104, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_104, MUSIC_ROUTE_104, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map Route101HealHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_101, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map DayOfWeekSiblingsHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_101, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route102SandstormHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_102, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route104Route121Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_104, MUSIC_ROUTE_104, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route122, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_122, MUSIC_ROUTE_104, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN ; new, TBE (music)
...
MapGroup_Cherrygrove:
	...
	map Route105, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_105, MUSIC_ROUTE_105, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route106, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_106, MUSIC_ROUTE_105, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map Route105BerryHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_105, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MrPokemonsHouse, TILESET_FACILITY, INDOOR, LANDMARK_ROUTE_105, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route106VioletGate, TILESET_GATE, GATE, LANDMARK_ROUTE_106, MUSIC_ROUTE_105, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CHERRYGROVE_MAPS

; new

MapGroup_Elderfern: ; music TBE
	table_width MAP_LENGTH, MapGroup_Elderfern
	map ElderfernTown, TILESET_JOHTO, TOWN, LANDMARK_ELDERFERN_TOWN, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route123, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_123, MUSIC_ROUTE_105, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route107Route123Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_123, MUSIC_ROUTE_105, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route124, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_124, MUSIC_ROUTE_105, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map AzaleaTownRoute124Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_124, MUSIC_ROUTE_105, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route125, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_125, MUSIC_ROUTE_105, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map GoldenrodCityRoute125Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_125, MUSIC_ROUTE_105, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route126, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_126, MUSIC_ROUTE_105, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route111Route126Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_126, MUSIC_ROUTE_105, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_ELDERFERN_MAPS
