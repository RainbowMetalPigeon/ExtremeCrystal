...
- [maps/Route119.asm](https://github.com/pret/pokecrystal/blob/master/maps/Route119.asm): `TrainerBirdKeeperVance1` should use `PAL_NPC_BLUE`, not `PAL_NPC_GREEN`
- [maps/Route119.asm](https://github.com/pret/pokecrystal/blob/master/maps/Route119.asm): `TrainerPokemaniacZach` should use `PAL_NPC_BLUE`, not `PAL_NPC_GREEN`
...
Most of the NPCs in [maps/NationalParkBugContest.asm](https://github.com/pret/pokecrystal/blob/master/maps/NationalParkBugContest.asm) and [maps/Route111NationalParkGate.asm](https://github.com/pret/pokecrystal/blob/master/maps/Route111NationalParkGate.asm) are also inconsistent with their trainers from other maps:

- `BugCatchingContestant1AScript` and `BugCatchingContestant1BScript`: `BUG_CATCHER DON` from [maps/Route105.asm](https://github.com/pret/pokecrystal/blob/master/maps/Route105.asm) should use `SPRITE_BUG_CATCHER` and `PAL_NPC_BROWN`, not `SPRITE_YOUNGSTER` and `PAL_NPC_RED`
...
- `BugCatchingContestant9AScript` and `BugCatchingContestant9BScript`: `YOUNGSTER SAMUEL` from [maps/Route109.asm](https://github.com/pret/pokecrystal/blob/master/maps/Route109.asm) should use `PAL_NPC_BLUE`, not `PAL_NPC_GREEN`
